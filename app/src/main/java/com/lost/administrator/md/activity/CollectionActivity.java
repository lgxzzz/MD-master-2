...
private String user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        store = (CollectionBean) getIntent().getSerializableExtra("DATA");
        ...
        CollectionBean collect = DbSqliteHelper.getInstance(CollectionActivity.this).findColl(store.getName(), user);
